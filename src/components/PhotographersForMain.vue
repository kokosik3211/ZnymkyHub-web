    ...
    <section class="hero">
        <div class="hero-body">
            ...
            <h2 class="subtitle">
                ...
                <p class="has-text-centered is-size-6">Discover {{PhotographersCount}} more photographers on our site</p>
...
export default class PhotographersForMain extends Vue {
    ...
    created(){
        axios.post("http://localhost:5000/api/user/photographersformain").then(response => {
        ...
        axios.post("http://localhost:5000/api/user/photographerscount").then(response => {
