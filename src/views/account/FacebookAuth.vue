...
export default class FacebookAuth extends Vue {
 ...
 private launchFbLogin() {
    ...
    this.authWindow = window.open(`https://www.facebook.com/v3.2/dialog/oauth?&response_type=token&display=popup&client_id=695648134218868&display=popup&redirect_uri=http://localhost:8088/facebook-auth.html&scope=email`, '', 'width=600,height=400,top=400,left=400');
  }
