          ...
          <div class="card">
            <div class="card-content">
              <div class="content">
                ...
                <p v-if="homeData.location">
                  <strong>Location:</strong> {{ homeData.location }}
                </p>
                <p v-if="homeData.locale">
                  <strong>Locale:</strong> {{ homeData.locale }}
                </p>
                <p v-if="homeData.gender">
                  <strong>Gender:</strong> {{ homeData.gender }}
                </p>
                <p v-if="homeData.facebookId">
                  <strong>Facebook Id:</strong> {{ homeData.facebookId }}
                </p>
