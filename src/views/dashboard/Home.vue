    ...
    <section class="hero is-light" style="margin-top: 50px;">
      <div class="hero-body">
        <div class="container has-text-centered">
          <div v-if="homeData.firstName" class="columns is-multiline is-centered">
            <div class="column is-2">
                <div>
                  <b-tooltip label="Change photo"
                      type="is-dark"
                      position="is-top">
                    <avatar @click.native="$refs.imageInput.click()" :size="150" :username="name" :src="homeData.base64" title="kek" style="display: inline-block;"></avatar>
                  </b-tooltip>
                ...
                <p class="is-italic is-size-7" style="margin-bottom: 4px;">with us</p>
            ...
            <div class="column is-3">
              ...
              <p v-if="homeData.homeTown" class="has-text-left" style="margin-top:10px">
                <i class="fas fa-home mr-2"></i> {{ homeData.homeTown }}
              </p>
              <p v-if="homeData.instagramUrl" class="has-text-left" style="margin-top:10px">
                <i class="fab fa-instagram mr-2"></i> {{ homeData.instagramUrl }}
              </p>
              <p v-if="homeData.phoneNumber" class="has-text-left" style="margin-top:10px">
            ...
            <b-dropdown hoverable aria-role="list">
                ...
                <b-dropdown-item aria-role="listitem" @click="isPhotoModalActive = true"><i class="fas fa-image"></i> Photo</b-dropdown-item>
                <b-dropdown-item aria-role="listitem" @click="isPhotoshootModalActive = true"><i class="fas fa-images"></i> Photoshoot</b-dropdown-item>
            </b-dropdown>
...
export default class DashboardHome extends Vue {
  ...
  private onUpload(){
    ...
    axios.post(`http://localhost:5000/api/image/changeuserimage/${this.homeData.id}`, fd, {
        headers: {
